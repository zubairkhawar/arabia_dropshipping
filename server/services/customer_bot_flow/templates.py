...
BOT_FLOW_TEMPLATES: Dict[str, Dict[str, str]] = {
    ...
    "greeting": {
        "english": (
            ...
            "I'm AI DROPBOT — your assistant for everything from setup to scaling your store 🚀\n\n"
        ...
        "arabic": (
            ...
            "أنا **AI DROPBOT** — مساعدك لكل شيء من إعداد المتجر إلى توسيع نطاقه 🚀\n\n"
            "بماذا تريد المساعدة اليوم؟\n\n"
            "🔹 Dropshipping\n"
            "🔹 التخزين والشحن (Fulfillment)\n"
            "🔹 خدمات الشحن 3PL\n"
            "🔹 تأكيد الطلبات عبر واتساب\n"
            "🔹 برنامج شراكة الوكالة\n"
            "🔹 حاسبة الربح\n"
            "🔹 المدفوعات\n"
        ...
        "roman_urdu": (
            ...
            "Main **AI DROPBOT** hoon — setup se le kar store scale karne tak aap ka assistant 🚀\n\n"
    ...
    "order_verify_intro": {
        "english": (
            ...
            "3. *Tell me to show recent orders* if you don't have the number right now\n\n"
            "Once you provide your order number or email, I'll show you:\n"
        ...
        "arabic": (
            ...
            "3. *اطلب مني عرض آخر الطلبات* إذا لم يكن الرقم متوفراً الآن\n\n"
            "فور إرسال رقم الطلب أو البريد الإلكتروني، سأعرض لك:\n"
        ...
        "roman_urdu": (
            ...
            "3. *Bolein recent orders dikha doon* agar number abhi yaad nahi\n\n"
            "Order number ya email milte hi main ye dikhaoonga:\n"
    ...
    "account_verify_intro": {
        "english": (
            ...
            "3. *Ask me to show recent orders* if you don't have the number right now\n\n"
